...
class RestaurantSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            'name' => '仙人',
            'image_path' => config('const.DUMMY_IMAGES_PATH') . config('const.GENRE_IMAGE_NAMES')[0] . '.jpg',
            'area' => config('const.AREAS')[0],
            'genre' => config('const.GENRES')[0],
        ...
        $param = [
            'name' => '牛助',
            'image_path' => config('const.DUMMY_IMAGES_PATH') . config('const.GENRE_IMAGE_NAMES')[1] . '.jpg',
            'area' => config('const.AREAS')[1],
            'genre' => config('const.GENRES')[1],
        ...
        $param = [
            'name' => '戦慄',
            'image_path' => config('const.DUMMY_IMAGES_PATH') . config('const.GENRE_IMAGE_NAMES')[2] . '.jpg',
            'area' => config('const.AREAS')[2],
            'genre' => config('const.GENRES')[2],
        ...
        $param = [
            'name' => 'ルーク',
            'image_path' => config('const.DUMMY_IMAGES_PATH') . config('const.GENRE_IMAGE_NAMES')[3] . '.jpg',
            'area' => config('const.AREAS')[0],
            'genre' => config('const.GENRES')[3],
        ...
        $param = [
            'name' => '志摩屋',
            'image_path' => config('const.DUMMY_IMAGES_PATH') . config('const.GENRE_IMAGE_NAMES')[4] . '.jpg',
            'area' => config('const.AREAS')[2],
            'genre' => config('const.GENRES')[4],
