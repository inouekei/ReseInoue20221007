...
@endsection
@section('div-right-ttl', '送信内容')
@section('div-right-content')
<div>
    <form class='form-main' action={{'/reservation/' . $reservation->id . '/email'}}  method='post'>
        @csrf
        <input name='subject' placeholder='Subject' class='input-main input-full'>
        <textarea class='input-main input-full textarea-main' maxlength=191 name='message' placeholder='Message'></textarea>
